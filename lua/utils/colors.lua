...
function M.ColorMyPencils(color)
	...
	if color == "gruber-darker" then
		...
		vim.cmd("hi SnacksNormal guibg=#050505")
		vim.cmd("hi SnacksPicker guibg=#050505")
		vim.cmd("hi SnacksPickerBoxBorder guibg=#050505")
		vim.cmd("hi SnacksNormalNC guibg=#050505")
		vim.cmd("hi TroubleNormal guibg=#050505")
		vim.cmd("hi TroubleNormalNC guibg=#050505")
		vim.cmd("hi TroubleIndent guibg=#050505")
		vim.cmd("hi TroublePos guibg=#050505")
		vim.cmd("hi Comment guifg=#6f7b68")
